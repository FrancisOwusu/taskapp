...
final log1 = logger(SignUpForm1);

class SignUpForm1 extends StatefulWidget {
  const SignUpForm1({super.key});
  @override
  State<SignUpForm1> createState() => _SignUpFormFields();
}

final log2 = logger(_SignUpFormFields);

class _SignUpFormFields extends State<SignUpForm1> {
  final _formKey = GlobalKey<FormState>();
  RegExp get _emailRegex => RegExp(r'^\S+@\S+$');

  TextEditingController emailController = TextEditingController(
    text: LocalStorage.getToken(),
  );
